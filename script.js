    ...
    form.addEventListener('submit', function (e) {
        ...
        fetch(SCRIPT_URL, {
            ...
            .catch(error => {
                ...
                // Even if there is an error (which might happen with no-cors sometimes even on success), 
                // we might want to redirect or show error. 
                // For this use case, let's assume if fetch completes, we go to success.
                // But strictly, catch handles network errors.
